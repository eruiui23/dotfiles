...
nemo &
# sleep 1
# sh -c 'XAPP_FORCE_GTKWINDOW_ICON="whatsapp" firefox --class WebApp-WhatsApp5589 --name WebApp-WhatsApp5589 --profile /home/yucandy16/.local/share/ice/firefox/WhatsApp5589 --no-remote "https://web.whatsapp.com/"' &
sleep 2
